        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-2">
                <div className="flex flex-col gap-1">
                    <h1 className="text-3xl font-black tracking-tight text-slate-800 font-['DM_Sans',sans-serif] flex items-center gap-4">
                        ...
                        <span className={theme.text}>Client</span> Ecosystem
                    </h1>
                    <p className="text-slate-500 font-medium font-['DM_Sans',sans-serif] ml-16">Intelligence unit for client relations and capital flow.</p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
                <div className="relative flex-1 w-full">
                    ...
                    <Input
                        placeholder="Search strategic clients..."
                        value={searchQuery}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                {filteredSuppliers.length === 0 && (
                    <div className="col-span-full py-24 flex flex-col items-center justify-center text-center space-y-4">
                        ...
                        <div className="space-y-1">
                            <h3 className="text-xl font-bold text-slate-400 font-['DM_Sans',sans-serif]">No clients found</h3>
...
export default RetailClientsPage;
